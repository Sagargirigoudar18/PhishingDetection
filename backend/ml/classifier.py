...
if __name__ == "__main__":
    ...
    X = [
        ...
        "Hello, please find attached the report you requested.",
        "You've won a prize! Claim it now!",
        "Your monthly statement is ready to view."
    ]
    y = [1, 0, 1, 0]  # 1 for phishing, 0 for legitimate
    ...
    # Test prediction
    test_text = "Your bank account needs verification. Click now!"
    pred, proba = classifier.predict(test_text)
    print(f"Prediction: {'Phishing' if pred else 'Legitimate'} (Confidence: {proba:.2f})")
